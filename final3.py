...
# Remove dotenv loading as we'll use Streamlit's secrets management
...
st.markdown("""
    ...
    Please enter your API keys below to get started.
""")
...
with st.sidebar:
    ...
    sectors_api_key = st.text_input("Enter your Sectors API Key", type="password")
    openai_api_key = st.text_input("Enter your OpenAI API Key", type="password")

# Function to check if all API keys are provided
def are_api_keys_provided():
    return groq_api_key and sectors_api_key and openai_api_key

# Display warning if API keys are not provided
if not are_api_keys_provided():
    st.warning("Please enter all API keys in the sidebar to use the Financial Robo-Advisor.")

# Only show the main app content if API keys are provided
if are_api_keys_provided():
    # Your existing code goes here, replace environment variable calls with the input variables
    # For example:
    ...
    def get_performance_since_ipo(stock: str) -> str:
        ...
        Return with order chg_7d, chg_30d, chg_90d, chg_365d"""
...
# else:
#     st.info("Please enter your API keys in the sidebar to use the Financial Robo-Advisor.")